...
# Morgan adding code for DB connection and querying - this is what I used for querying RACEBASE so will need to be updated
library(DBI)
library(odbc)
library(tidyverse)
...
afsc <- DBI::dbConnect(odbc::odbc(), "afsc", 
                       UID = "MARRINGTON", PWD = "NMF$afsc2017")

#Run query
#,30060,21740) # Enter species code; # 21740 (Pollock), 30060 (POP), 30152/30150 (Dusky); 21720 (Pacific Cod)
specimen_dat_201902 <- sql_run(afsc,
        "SELECT * FROM RACEBASE.SPECIMEN 
        WHERE CRUISE = 201902 
        AND SPECIES_CODE = 21720
        AND VESSEL = 162")

write.csv(specimen_dat_201902, file ="C:/Users/morgan.arrington/Work/RACEBASE database access/Queries/pcod_201902.csv")
